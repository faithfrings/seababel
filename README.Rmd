...
The `seababel` package uses colors inspired by the SeaBABEL lab to provide a custom discrete and continuous color palette designed for use with base R or `ggplot2` visualizations.
